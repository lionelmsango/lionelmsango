...
|--------------|------------|-------------------|-------------|
| **Vulnerability Management Lab** | [vulnerability-management-lab](https://github.com/lionelmsango/vulnerability-management-lab)) | Greenbone OpenVAS, CVSS, EPSS, Windows Server 2022, Metasploitable 2  | Enterprise VM workflow: unauthenticated and authenticated scanning, CVSS/EPSS risk prioritisation, documented remediation cycle with verified rescan. Collaborative project with  Anne Zamorowski (@codingfox86)
