...
|--------------|------------|-------------------|-------------|
| **Azure Cloud Infrastructure Lab** | [Azure-Cloud-Infrastructure-Lab](https://github.com/lionelmsango/Azure-Cloud-Infrastructure-Lab) | Azure, Win server 2022, Azure VNet segmentation| Production-ready cloud infrastructure on Azure with VNet segmentation, NSG security, automated backups, and cost optimization  | automated backups | cost optimization (95% savings, <€1 total) | 
